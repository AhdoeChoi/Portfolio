...
public:
	XMFLOAT3 NormalV;
	void SetNormalV(XMFLOAT3 nv) { NormalV = nv; }
public:
...
protected:
	...
	//CMesh *m_pMesh = NULL;
	CMesh **m_ppMeshes = NULL; //protected로 해도 되나?
	int m_nMeshes = 0;
...
public:
	...
	void SetPlaneNormalVectorFRONT(XMFLOAT3 PlanenvR) { PlaneNormalVectorRIGHT = PlanenvR; }
