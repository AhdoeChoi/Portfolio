...
{ 
	...
	m_xmf3Right = XMFLOAT3(1.0f, 0.0f, 0.0f); m_xmf3Look = XMFLOAT3(0.0f, 0.0f, 1.0f); 
	m_xmf3Up = XMFLOAT3(0.0f, 1.0f, 0.0f); m_fPitch = 0.0f; m_fRoll = 0.0f;
	m_fYaw = 0.0f; m_xmf3Offset = XMFLOAT3(0.0f, 0.0f, 0.0f);
	m_fTimeLag = 0.0f; m_xmf3LookAtWorld = XMFLOAT3(0.0f, 0.0f, 0.0f); 
	m_nMode = 0x00; 
	m_pPlayer = NULL;
...
{ 
	...
	//m_xmf4x4ViewPositionReverse = m_xmf4x4View;
	/*m_xmf4x4ViewPositionReverse._41 *= -1;
	m_xmf4x4ViewPositionReverse._42 *= -1;
	m_xmf4x4ViewPositionReverse._43 *= -1;*/
	/*m_xmf4x4View._41 *= -1;
	m_xmf4x4View._42 *= -1;
	m_xmf4x4View._43 *= -1;*/
...
{ 
	...
	m_xmf4x4View._41 = -Vector3::DotProduct(m_xmf3Position, m_xmf3Right); // 왜 내적한거에 마이너스?
	m_xmf4x4View._42 = -Vector3::DotProduct(m_xmf3Position, m_xmf3Up);
	m_xmf4x4View._43 = -Vector3::DotProduct(m_xmf3Position, m_xmf3Look);
}
void CCamera::UpdateShaderVariables(ID3D12GraphicsCommandList *pd3dCommandList) 
{
	XMFLOAT4X4 xmf4x4View; XMStoreFloat4x4(&xmf4x4View, XMMatrixTranspose(XMLoadFloat4x4(&m_xmf4x4View)));
	//루트 파라메터 인덱스 1의
