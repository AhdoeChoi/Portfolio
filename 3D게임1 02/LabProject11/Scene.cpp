...
void CScene::AnimateObjects(float fTimeElapsed, ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList)
{
	for (int i = 0; i < m_nShaders; i++) { m_pShaders[i].AnimateObjects(fTimeElapsed,pd3dDevice,pd3dCommandList); }
...
ID3D12RootSignature *CScene::CreateGraphicsRootSignature(ID3D12Device *pd3dDevice) 
{
	...
	d3dRootSignatureDesc.pParameters = pd3dRootParameters; d3dRootSignatureDesc.NumStaticSamplers = 0;
