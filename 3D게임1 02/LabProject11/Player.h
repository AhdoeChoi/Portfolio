...
public:
	...
	void Setxmf3Position(XMFLOAT3& setxmf3Position) { m_xmf3Position.x += setxmf3Position.x, m_xmf3Position.y += setxmf3Position.y, m_xmf3Position.z += setxmf3Position.z; }
